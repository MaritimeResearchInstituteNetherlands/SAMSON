...
for alpha in ALPHAS:
    ...
    node_gdf = gpd.GeoSeries(node_dict, crs=CRS)
    node_gdf = node_gdf.to_crs(EPSG)
    ...
    df_vertices.to_csv(vertices_export, index=False, header=True)
    ...
    df_waypoints.to_csv(waypoints_export, index=False, header=True)
    ...
    df_links.to_csv(links_export, index=False, header=True)
    ...
    df_shiplinks.to_csv(shiplinks_export, index=False, header=True)
    ...
    df_shiplinkdata.to_csv(shiplinkdata_export, index=False, header=True)
