...
:Objective:
  ...
  and confirm that the anchor function is correctly implemented. 
:Criteria:
...
.. _fig_Comparison_Collisions_Link_Anchor:

.. figure:: figure1.svg
   :alt: Comparison:Collisions:Link:Anchor
   :align: center
